...
// Ghost demo nodes — tutorial spirits that vanish when user adds first real node
export const GHOST_DEMO_NODES: SomaticNode[] = [
  {
    id: 'ghost-welcome',
    nameRu: '✨ Добро пожаловать в Seamless Universe',
    nameEn: '✨ Welcome to Seamless Universe',
    type: 'concept',
    level: 'macro',
    domain: 'hybrid',
    world: 'field',
    ...
    carries: 0,
    score: 1,
    descriptionRu: 'Это живая карта смыслов. Долгий тап на любой ноде открывает меню: резонируй, связывай, неси в свой мир или пиши истории. Попробуй 👆',
    descriptionEn: 'This is a living map of meaning. Long-press any node to open the radial menu: resonate, connect, carry to your world, or write stories. Try it 👆',
    addedBy: 'seamless',
  ...
  {
    id: 'ghost-field',
    nameRu: '🌌 Поле — пространство идей',
    nameEn: '🌌 The Field — space of ideas',
    type: 'concept',
    level: 'macro',
    domain: 'philosophy',
    world: 'field',
    ...
    carries: 0,
    score: 1,
    descriptionRu: 'Здесь рождаются новые смыслы. Добавляй наблюдения, вопросы и практики. Ноды живут в Поле пока не наберут силу — тогда они возносятся в Атлас.',
    descriptionEn: 'New meanings are born here. Add observations, questions, and practices. Nodes live in the Field until they gain strength — then they ascend to the Atlas.',
    addedBy: 'seamless',
    lastActiveAt: Date.now(),
    isPrivate: false,
    x: -2, y: 1.5, z: 1,
  ...
  {
    id: 'ghost-atlas',
    nameRu: '🗺️ Атлас — вечный архив',
    nameEn: '🗺️ Atlas — eternal archive',
    type: 'concept',
    level: 'macro',
    domain: 'science',
    world: 'field',
    ...
    carries: 0,
    score: 1,
    descriptionRu: 'Атлас хранит проверенные связи между соматикой, наукой, философией и движением. 6 доменов-созвездий. Исследуй их.',
    descriptionEn: 'The Atlas stores verified connections between somatics, science, philosophy, and movement. 6 domain-constellations. Explore them.',
    addedBy: 'seamless',
    lastActiveAt: Date.now(),
    isPrivate: false,
    x: 1.5, y: -1, z: -1.5,
  ...
  },
  {
    ...
    carries: 0,
    score: 1,
    descriptionRu: 'Зажми палец на любой ноде 1 секунду — появится меню с кнопками: ♦ резонировать, ⟷ связать, ↗ нести в Мой мир, + добавить историю',
    descriptionEn: 'Long-press any node for 1 second — a menu appears: ♦ resonate, ⟷ connect, ↗ carry to My World, + add a story',
    addedBy: 'seamless',
    lastActiveAt: Date.now(),
    isPrivate: false,
    x: 0.5, y: -2, z: 2,
...
export const INITIAL_NODES: SomaticNode[] = [...ATLAS_NODES, ...FIELD_SEED_NODES, ...GHOST_DEMO_NODES];
...
export const SAMPLE_AUDIO: AudioItem[] = [
  {
    id: 'aud-podcast',
    titleRu: 'Seamless: Страх и Соматика',
    titleEn: 'Seamless: Fear and Somatic Practice',
    authorRu: 'Seamless Podcast',
    authorEn: 'Seamless Podcast',
    sourceRu: 'Seamless Research',
    sourceEn: 'Seamless Research',
    year: 2026,
    duration: 360,
    domain: 'philosophy',
    audioUrl: '/audio/seamless-podcast-v4.mp3',
    timelineNodes: [
      { timeMs: 5000, nodeId: 'fear', captionRu: 'О страхе в соматике.', captionEn: 'On fear in somatics.' },
      { timeMs: 90000, nodeId: 'somatics', captionRu: 'Тело как живой ум.', captionEn: 'Body as live mind.' },
      { timeMs: 180000, nodeId: 'proprioception', captionRu: 'Проприоцепция.', captionEn: 'Proprioception.' }
    ]
  },
  {
    id: 'aud-podcast-2',
    titleRu: 'Seamless: Движение и Тело',
    titleEn: 'Seamless: Movement and Body',
    authorRu: 'Seamless Podcast',
    authorEn: 'Seamless Podcast',
    sourceRu: 'Seamless Research',
    sourceEn: 'Seamless Research',
    ...
    duration: 360,
    domain: 'movement',
    audioUrl: '/audio/seamless-podcast-v3.mp3',
    timelineNodes: [
      { timeMs: 5000, nodeId: 'proprioception', captionRu: 'Проприоцепция как основа.', captionEn: 'Proprioception as foundation.' },
      { timeMs: 60000, nodeId: 'contact_improv', captionRu: 'Контактная импровизация.', captionEn: 'Contact improvisation.' },
      { timeMs: 120000, nodeId: 'feldenkrais', captionRu: 'Метод Фельденкрайза.', captionEn: 'Feldenkrais Method.' }
    ]
  },
  {
    id: 'aud-overview',
    titleRu: 'Seamless Universe — Обзор',
    titleEn: 'Seamless Universe — Overview',
    authorRu: 'Seamless AI',
    authorEn: 'Seamless AI',
    sourceRu: 'AI Overview',
    sourceEn: 'AI Overview',
    year: 2026,
    duration: 300,
    domain: 'science',
    audioUrl: '/audio/EN_Audio_Overview.mp3',
    timelineNodes: [
      { timeMs: 3000, nodeId: 'artificial_intelligence', captionRu: 'Что такое Seamless Universe?', captionEn: 'What is Seamless Universe?' }
    ]
  },
  {
    id: 'aud-background',
    titleRu: 'Нейро-музыка для погружения',
    titleEn: 'Neuro ambient background',
    authorRu: 'Seamless Lab',
    authorEn: 'Seamless Lab',
    sourceRu: 'Лаборатория',
    sourceEn: 'Lab Sessions',
    year: 2026,
    duration: 180,
    domain: 'hybrid',
    audioUrl: '/audio/neuro_speech_background.mp3',
    timelineNodes: []
  }
];
